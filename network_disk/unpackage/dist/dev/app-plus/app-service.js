...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _navBar = _interopRequireDefault(__webpack_require__(/*! ../../components/common/nav-bar.vue */ 7));\nvar _fList = _interopRequireDefault(__webpack_require__(/*! ../../components/common/f-list.vue */ 18));\nvar _fDialog = _interopRequireDefault(__webpack_require__(/*! @/components/common/f-dialog.vue */ 23));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-ui/uni-popup/uni-popup.vue */ 28));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { navBar: _navBar.default, fList: _fList.default, fDialog: _fDialog.default, uniPopup: _uniPopup.default }, data: function data() {return { renameValue: '', newdirname: '', sortIndex: 0, sortOptions: [{ name: '按名称排序' }, { name: '按时间排序' }], list: [{ type: 'dir', name: '我的笔记', create_time: '2020-10-21 08:00', checked: false }, { type: 'image', name: '壁纸.jpg', data: 'https://imgs.aixifan.com/o_1e09h5sut1uh39g56d1eqa1l4rv.jpg', checked: false }, { type: 'image', name: '壁纸.jpg', data: 'https://img.3dmgame.com/uploads/images/news/20200519/1589880846_790618.jpg', checked: false }, { type: 'video', name: 'RADWIMPS1.mp4', data: '../../static/video/RADWIMPS1.mp4', checked: false }, { type: 'video', name: 'RADWIMPS2.mp4', data: '../../static/video/RADWIMPS2.mp4', checked: false }, { type: 'text', name: '记事本.txt', create_time: '2020-10-21 08:00', checked: false }, { type: 'none', name: '压缩包.rar', create_time: '2020-10-21 08:00', checked: false }], addList: [{ icon: 'icon-file-b-6', color: 'text-success', name: '上传图片' }, { icon: 'icon-file-b-9', color: 'text-primary', name: '上传视频' }, { icon: 'icon-file-b-8', color: 'text-muted', name: '上传文件' }, { icon: 'icon-file-b-2', color: 'text-warning', name: '新建文件夹' }] };\n  },\n  onLoad: function onLoad() {\n    // uni.request({\n    // \turl: 'http://localhost:7001/list',\n    // \tmethod: 'GET',\n    // \tsuccess: res => {\n    // \t\tthis.list = res.data.data;\n    // \t\tconsole.log(this.list[0].type);\n    // \t}\n    // });\n  },\n  methods: {\n    select: function select(e) {\n      this.list[e.index].checked = e.value;\n    },\n    //全选/取消全选\n    handleCheckAll: function handleCheckAll(checked) {\n      this.list.forEach(function (item) {\n        item.checked = checked;\n      });\n    },\n    //处理底部操作时间\n    handleBottomEvent: function handleBottomEvent(item) {var _this = this;\n      switch (item.name) {\n        case '删除':\n          this.$refs.delete.open(function (close) {\n            //对List进行过滤，留下未被选中的\n            _this.list = _this.list.filter(function (item) {return !item.checked;});\n            close();\n            uni.showToast({\n              title: '删除成功',\n              icon: 'none' });\n\n          });\n          break;\n        case '重命名':\n          //只能对单个文件进行，所以取this.checkList[0],也就是选中的唯一元素\n          this.renameValue = this.checkList[0].name;\n          this.$refs.rename.open(function (close) {\n            if (_this.renameValue == '') {\n              return uni.showToast({\n                title: '文件名称不能为空',\n                icon: 'none' });\n\n            }\n            _this.checkList[0].name = _this.renameValue;\n            close();\n          });\n          break;\n        default:\n          break;}\n\n    },\n    //打开添加操作条\n    openAddDialog: function openAddDialog() {\n      this.$refs.add.open();\n    },\n    handleAddEvent: function handleAddEvent(item) {var _this2 = this;\n      this.$refs.add.close();\n      switch (item.name) {\n        case '新建文件夹':\n          this.$refs.newdir.open(function (close) {\n            if (_this2.newdirname == '') {\n              return uni.showToast({\n                title: '文件夹名称不能为空',\n                icon: 'none' });\n\n            }\n            //模拟请求服务器，这里先增加到List数组中\n            _this2.list.push({\n              type: 'dir',\n              name: _this2.newdirname,\n              create_time: '2020-10-23',\n              checked: false });\n\n            uni.showToast({\n              title: '新建文件夹成功',\n              icon: 'none' });\n\n            close();\n          });\n          break;\n        default:\n          break;}\n\n    },\n    doEvent: function doEvent(item) {\n      switch (item.type) {\n        case 'image':\n          var images = this.list.filter(function (item) {\n            return item.type === 'image';\n          });\n          uni.previewImage({\n            current: item.data,\n            urls: images.map(function (item) {return item.data;}) });\n\n          break;\n\n        case 'video':\n          uni.navigateTo({\n            url: '../video/video?url=' + item.data + '&title=' + item.name });\n\n          break;\n        default:\n          break;}\n\n    },\n    //根据排序类型的索引切换不同的排序，关闭sort排序框\n    changeSort: function changeSort(index) {\n      this.sortIndex = index;\n      this.$refs.sort.close();\n    },\n    //打开sort排序框\n    openSortDialog: function openSortDialog() {\n      this.$refs.sort.open();\n    } },\n\n  computed: {\n    //选中列表\n    checkList: function checkList() {\n      return this.list.filter(function (item) {return item.checked;});\n    },\n    //选中数量\n    checkCount: function checkCount() {\n      return this.checkList.length;\n    },\n    //操作菜单\n    actions: function actions() {\n      if (this.checkCount > 1) {\n        return [\n        {\n          icon: 'icon-xiazai',\n          name: '下载' },\n\n        {\n          icon: 'icon-shanchu',\n          name: '删除' }];\n\n\n      }\n      return [\n      {\n        icon: 'icon-xiazai',\n        name: '下载' },\n\n      {\n        icon: 'icon-fenxiang-1',\n        name: '分享' },\n\n      {\n        icon: 'icon-shanchu',\n        name: '删除' },\n\n      {\n        icon: 'icon-chongmingming',\n        name: '重命名' }];\n\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///6\n");
...
var render = function() {
  ...
  return _c("view", [
    ...
    _c(
      ...
      [
        _c("text", {
          staticClass: _vm._$s(18, "sc", "text-muted font"),
          attrs: { _i: 18 }
        }),
        _c("image", {
          attrs: {
            src: _vm._$s(19, "a-src", __webpack_require__(/*! ../../static/jiantou.png */ 46)),
            _i: 19
          }
        })
      ]
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {};\n  },\n  methods: {\n    handleLogin: function handleLogin() {\n      uni.navigateTo({\n        url: '../login/login' });\n\n    } },\n\n  onLoad: function onLoad() {\n    __f__(\"log\", this.$store.state.user, \" at pages/my/my.vue:50\");\n  } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 49)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///48\n");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _default =\n{\n  onLaunch: function onLaunch() {\n    __f__(\"log\", this.$store.state, \" at App.vue:4\");\n  },\n  onShow: function onShow() {\n    __f__(\"log\", 'App Show', \" at App.vue:7\");\n  },\n  onHide: function onHide() {\n    __f__(\"log\", 'App Hide', \" at App.vue:10\");\n  } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 49)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///64\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 61));\nvar _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 66));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}\n_vue.default.use(_vuex.default);\n\n// import $H from '../common/request.js'\nvar _default = new _vuex.default.Store({\n  state: {\n    user: null,\n    token: null },\n\n  actions: {\n    login: function login(_ref, user) {var state = _ref.state;\n      state.user = user;\n      state.token = user.token;\n\n      uni.setStorageSync('user', JSON.stringify(user));\n      uni.setStorageSync('token', user.token);\n    } } });exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///65\n");
